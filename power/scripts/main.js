    ...
    setupScrollEffects() {
        ...
        window.addEventListener('scroll', () => {
            ...
            if (currentScrollY > 50) {
                ...
                navElement.style.boxShadow = '0 12px 40px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.12)';
            } else {
                navElement.style.background = 'rgba(255, 255, 255, 0.06)';
                navElement.style.backdropFilter = 'blur(50px) saturate(200%)';
                navElement.style.boxShadow = '0 8px 32px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1)';
            }
